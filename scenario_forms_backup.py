        ...
        try:
            ...
            def save_scenario():
                ...
                try:
                    ...
                    if refresh_callback:
                        refresh_callback()
                    login_step_count = len(get_login_steps()) if include_login and username and password else 0
                    self.show_popup("Success", f"Scenario #{next_number} created with {len(selected_steps) + login_step_count} steps!", "success")
